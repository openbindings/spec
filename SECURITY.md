...
- affected files/sections (and spec version if relevant)
- proof-of-concept or reproduction steps (if applicable)
- suggested remediation (if you have one)

## Disclosure

Please do not publicly disclose security-sensitive issues until the maintainers have had a chance to respond and coordinate a fix.
