...
- **CONN-P-02**: Schema-mode input and decode follow `openbindings.grpc@1`'s correspondence — canonical JSON forms, unknown input fields refused, unknown response members tolerated and dropped, absent-input rules, pre-dispatch refusals — per [§9.2](#92-schema-mode-input-and-decode).
