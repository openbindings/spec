...
| operation-key spelling, and the key derived for a lone anonymous operation | §11.2 | one operation per represented or lossy operation definition; the emitted input and output schemas and every disposition are fixed |
