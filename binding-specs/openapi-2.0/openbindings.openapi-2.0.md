...
| 5 — the syntax and meaning of `selector`, including the absent-`selector` case | §3.2, §5.1, §6, §12.3 | §3.2's vocabulary names no member for a selector that does not resolve; §6 states that disposition in the words §3.2 binds to an addressable target that is unusable |
