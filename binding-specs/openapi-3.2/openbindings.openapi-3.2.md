...
**[B — limit]** Repeated-name form decoding therefore does not arise under this identifier: the form and multipart lanes have no response direction, so nothing selects them for decoding.
