...
**[convention]** The fixed-field `query` operation follows that same permitted-body rule: its Request Body remains effective, a supplied body is preserved, and `required: true` is enforced. QUERY is not TRACE and has no separate body suppression.
