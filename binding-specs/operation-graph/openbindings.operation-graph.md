...
- **OG-T-03** (executing graphs): MUST evaluate node expressions in the pinned language of [Transforms](#transforms) — JSONata 2.1, jsonata-js 2.1.1 tiebreak — whose evaluation commitments deliberately align with the core specification's binding transforms (the draft's core §5.5, since removed; see the [changelog](../../CHANGELOG.md)).
