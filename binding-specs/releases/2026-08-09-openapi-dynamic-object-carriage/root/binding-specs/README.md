...
1. A specification may incorporate an existing artifact format and protocol. `openbindings.openapi@5` incorporates OpenAPI and HTTP.
...
| openapi         | [openbindings.openapi.md](openapi/openbindings.openapi.md)                         | **published** (v5 latest; v1–v4 immutable; implemented by both reference SDKs and `ob`) | `openbindings.openapi@5`         | JSON Pointer to the operation object                                                                                                                               |
