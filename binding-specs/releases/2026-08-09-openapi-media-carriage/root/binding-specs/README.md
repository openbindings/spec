...
| openapi         | [openbindings.openapi.md](openapi/openbindings.openapi.md)                         | **published** (v3 latest; v1–v2 immutable)                                            | `openbindings.openapi@3`         | JSON Pointer to the operation object                                                                                                                               |
