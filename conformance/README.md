...
| OBI-D-18 | Complete. Transform syntax at named and inline positions under the documented JSONata 2.1 language. Positives include expressions whose evaluation can fail. A validator without the required parse capability leaves the rule unverified. |
