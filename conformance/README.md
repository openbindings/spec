...
|---|---|---|
| [`binding-specs/`](binding-specs/README.md) | Source rules (D-rules), portable processor scenarios covering every P-rule, and portable artifact-to-OBI synthesis accounting for the seven standalone brownfield synthesis binding specifications — `openbindings.usage@1`, `openbindings.openapi@2`, `openbindings.mcp@2`, `openbindings.grpc@1`, `openbindings.connect@1`, `openbindings.asyncapi@1`, `openbindings.graphql@2` | `node scripts/verify-binding-specs.mjs` (shape and coverage; family adapters execute behavior) |
