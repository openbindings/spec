...
The current corpus contains 1092 scenarios citing every P-rule of usage,
...
coverage loss. The 228 scenarios
...
| GQL-D-04   | 5/21        | schema-validity gate subset; undefined type, missing query root, repeated names (field, type, directive, extension field), input-in-output, output-in-input, schema-definition count, and null or scalar queryType negatives
