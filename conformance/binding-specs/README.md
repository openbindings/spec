...
The current corpus contains 552 scenarios covering every P-rule of usage,
...
hostile-pass fix-round and Go engine-round batches, and the Round R
upstream-invalid Response Object batch (57 distinct rules). It
...
(`invalid` source units do not count as upstream-valid). The 105 scenarios
