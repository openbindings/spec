...
The current corpus contains 592 scenarios covering every P-rule of usage,
...
and the scenario round that exercises the rules the chain-trace program added
to the 2.0 document (57 distinct rules). It
