...
The OBI doesn't implement protocol logic. It just tells binding invokers where to look. See [Creators and Invokers](creators-and-invokers.md) and [Consuming an OpenBindings Interface](consuming-an-interface.md) for more on how this works.
