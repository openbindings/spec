# OpenBindings 0.2 Core Analysis: Discussion and Decision Record (archived)

## Status and purpose

This archived document is the non-normative working record of conclusions
reached while discussing
[`0.2-core-analysis.md`](0.2-core-analysis.md). It informed the 0.2 working
draft, is not an active issue list, is not part of the specification, and does
not define conformance.
